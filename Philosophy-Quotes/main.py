...
L = [
 ...
 '“What is rational is actual and what is actual is rational” – G. W. F. Hegel',
  ...
  '“The mind is furnished with ideas by experience alone” – John Locke',
  ' "Human life is suffering" (Vīta hūmāna est supplicim) - Seneca',
  ...
  '"Men are so simple of mind, and so much dominated by their immediate needs, that a decietful man will always find plenty who are ready to be deceived." - Niccolò Machiavelli',
  ...
  ' "Only see how large the soul is! - that if a man is drowned in the sea, what a great bubble comes up out of the top of the water! ... this is wind - is the soul that is the last to ascend out of the deep to glory ... the bubble is the soul" - Lord Timothy Dexter',
  '“My friends & fellow mortals there is A first Cose of all things” - Lord Timothy Dexter'
]
R = [
  'What do you think of this?',
  'Do you agree? Why or Why not?',
  'What would your favorite philosopher think of this quote?',
  'Why do you think this philosopher thought this?',
  'Is this thought compatible with your view of the human person?',
  'Unto what end did this philosopher aim?',
  'How does this relate to your personal final cause or end?',
